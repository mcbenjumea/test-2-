...
function renderCategoryButton(category) {
    ...
    return `
        <button class="categoria categoria-boton js-categoria-boton" id="categoria-${category.id}" type="button" aria-expanded="false" aria-controls="${panelId}" data-panel="${panelId}">
...
function renderCategoryPanel(category) {
    ...
    return `
        <section class="panel-categoria" id="panel-${category.id}" hidden>
